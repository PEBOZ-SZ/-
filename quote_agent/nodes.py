...
def update_session(state: QuoteAgentState, deps: QuoteAgentDeps) -> dict[str, Any]:
    ...
    if isinstance(quote, dict) and quote and mode == "commit":
        ...
        snap["quote_mode"] = "production_mode"
        quote["quote_mode"] = str(quote.get("quote_mode") or "production_mode")
        ...
        if finalize is not None:
            finalize(
                ...
                structured_input=snap,
                quote_mode=str(quote.get("quote_mode") or snap.get("quote_mode") or ""),
